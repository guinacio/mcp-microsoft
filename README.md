...
- `create_draft` / `create_reply_draft` / `get_draft` / `list_drafts` / `update_draft` / `send_draft` — full draft lifecycle, including reply and reply-all drafts
